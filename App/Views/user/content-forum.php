          ...
          <div class="single-post">
            ...
            <div class="blog_details">
              ...
              <ul class="blog-info-link mt-3 mb-4">
                <li><a href="#" class="badge badge-light">Lifestyle</a></li>
                <li><a href="#" class="badge badge-light">Sport</a></li>
              </ul>
            ...
            <div class="navigation-top">
              <div class="d-sm-flex justify-content-between text-center">
                ...
                <ul class="social-icons">
                  <li><p class="comment-count"><span class="align-middle"><i class="far fa-comment"></i></span>06</p></li>
