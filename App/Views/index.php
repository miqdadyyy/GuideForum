    ...
    <div class="container">
      ...
      <div class="row align-items-center text-center text-md-left">
        <div class="col-md-6 col-lg-5 mb-5 mb-md-0">
          <h1>Traveller.id</h1>
          <p>Traveller.id - Forum berbagi pengalaman wisata Indonesia kepada seluruh warga dunia, untuk menunjukkan betapa indahnya Indonesia yang kita tempati ini</p>
            ...
            <div class="row">
              <div class="col-lg-10 offset-lg-1">
                <div class="tour-content">
                  ...
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus aspernatur, suscipit repellendus
                    pariatur nulla quisquam vero. Doloremque modi saepe expedita exercitationem perspiciatis tempora
                    ...
                    <form class="search-form" action="#">
                      ...
                      <div class="form-group">
                        <select name="Country" id="Country">
                          ...
                          <option value="8 AM">Indonesia</option>
                          <option value="12 PM">Chinaa</option>
                        </select>
                      </div>
                      <div class="form-group">
